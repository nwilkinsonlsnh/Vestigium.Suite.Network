...
| Location | Holds |
|---|---|
| Current plans | `WPF/NicIQ/PR-Plans` (this folder) |
| Prior plans | `WPF/NicIQ/PR-Plans/Completed` |
...
Which NIC, is it up, how fast. List + detail + watch. No packet send. No plot.  
