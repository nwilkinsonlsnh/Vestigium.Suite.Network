...
| Location | Holds |
|---|---|
| Current plans | `WPF/PingIQ/PR-Plans` (this folder) |
| Prior plans | `WPF/PingIQ/PR-Plans/Completed` |
...
Four echoes. Reply list. Cancel. Bind optional. No campaign. No PathMtu. No plot.  
