...
**Host:** `Vestigium.Suite.Network.ShareIQ`  
**APPID:** `ShareIQ`  
...
| Location | Holds |
|---|---|
| Queue keeper | `WPF/ShareIQ/PR-Plans/README.md` (this file) |
| Live plan | `WPF/ShareIQ/PR-Plans/PRnn/PRnn -- Implementation Plan.md` |
| Finished plan | `WPF/ShareIQ/PR-Plans/Completed/PRnn/` |
...
One UNC. One run. No password. No scheduler.  
Source: `src/Vestigium.Suite.Network.ShareIQ`
